...
const glowFollow = computed(() => formatter.value.glowFollow)
...
const followMouse = computed(() => glowFollow.value && pressed.value)
...
<template>
  <span
    ...
    :style="{
      ...
      background: `linear-gradient(to right, rgb(${getRandomInt(0,255)},${getRandomInt(0,255)},${getRandomInt(0,255)}), rgb(${getRandomInt(0,255)},${getRandomInt(0,255)},${getRandomInt(0,255)}), rgb(${getRandomInt(0,255)},${getRandomInt(0,255)},${getRandomInt(0,255)}))`,
      filter: `blur(${blur}px)`,
    }"
